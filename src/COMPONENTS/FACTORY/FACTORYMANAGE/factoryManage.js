    ...
    return (
        ...
        <Link to={`factory/${id}`}>
            <s.FactoryBox>
                ...
                <img src="https://cdn.pixabay.com/photo/2016/01/19/18/00/city-1150026_960_720.jpg" alt="" />
                <s.FlexBox>
                    <s.FactoryName>{name}</s.FactoryName>
                    <s.DetainInfor>
                        <s.Location
                            onClick={() => window.location.href = `https://www.google.co.kr/maps/place/${location}`}
                        >공장 주소 : {location}</s.Location>
